const CACHE_VERSION = "20260403b";
const STATIC_CACHE = `dta-checker-static-${CACHE_VERSION}`;
const RUNTIME_CACHE = `dta-checker-runtime-${CACHE_VERSION}`;

const CORE_ASSETS = [
  "./",
  "./index.html",
  "./styles.css",
  "./dta-app.mjs?v=20260403b",
  ...
  "./calendar-icon.svg",
  "./calendar-icon.svg?v=20260403b",
  "./calendar-icon-180.png",
  "./calendar-icon-180.png?v=20260403b",
